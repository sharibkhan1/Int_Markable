  ...
  return (
      ...
      <div className="w-full  h-full dark:bg-muted bg-white rounded-lg shadow-lg p-4">
        ...
        <Dialog>
          ...
          className="sticky z-20 top-0 mb-4 dark:bg-[#FFC83A] px-4 py-2 rounded-md border border-black bg-[#FFC83A] text-black text-sm hover:shadow-[4px_4px_0px_0px_rgba(0,0,0)] transition duration-200"
            ...
            <div>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <Button type="submit" className="bg-[#FFC83A] text-[#333333] px-8 py-2 rounded-md font-bold transition duration-200 hover:bg-white hover:text-black border-2 border-transparent hover:border-[#FFC83A]">Submit</Button>
                </form>
              </Form>
            </div>
          </DialogContent>
